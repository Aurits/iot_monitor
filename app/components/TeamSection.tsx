...
const teamMembers = [
    { name: 'Ambrose', role: 'Lead Developer', github: '#', linkedin: '#', twitter: '#' },
    { name: 'Cynthia', role: 'UX Designer', github: '#', linkedin: '#', twitter: '#' },
    { name: 'Jelly', role: 'Project Manager', github: '#', linkedin: '#', twitter: '#' },
    { name: 'Kevin', role: 'IoT Specialist', github: '#', linkedin: '#', twitter: '#' },
];
